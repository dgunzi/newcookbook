...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        // messages
        messages: {
            typeError: "{file} 的文件类型不支持上传. 支持的文件类型有: {extensions}。",
            sizeError: "{file} 文件过大, 文件最大限制为 {sizeLimit}。",
            minSizeError: "{file} 文件太小, 文件最小限制为 {minSizeLimit}。",
            emptyError: "{file} 为空, 请重新选择文件。",
            noFilesError: "没有要上传的文件。",
            onLeave: "文件正在上传, 如果现在离开文件将取消上传。"
        },
...
qq.FileUploaderBasic.prototype = {
    ...
    _onComplete: function(id, fileName, result){
        ...
        if (!result.success){
            var errorReason = result.error ? result.error : "上传失败的原因未知";
